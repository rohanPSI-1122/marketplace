...
public class SecurityConfig {
    ...
    @Autowired
    private JwtAuthenticationFilter jwtAuthenticationFilter; // ← Inject it

    @Bean
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            .addFilterBefore(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class) // ✅ Critical: Add JWT filter early
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.addAllowedOrigin("http://192.168.1.40:3000");
